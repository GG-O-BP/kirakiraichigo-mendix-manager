...
pub async fn read_widget_bundle(widget_path: &Path) -> Result<(String, Option<String>), String> {
...
pub async fn find_widget_bundle_recursive(dir: &Path) -> Option<std::path::PathBuf> {
